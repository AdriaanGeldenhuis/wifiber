...
<div class="portal-card">
  ...
  <p class="muted small" style="margin-top:14px;">
    Token registration runs through the native-app API at
    <code>POST /account/api/push.php</code> (auth: customer session cookie + CSRF).
    Stale tokens auto-revoke when FCM returns <code>404 UNREGISTERED</code>,
    <code>NOT_FOUND</code>, or <code>SENDER_ID_MISMATCH</code>.
  </p>
