...
<form method="post" class="form" id="client-form">
  ...
  <div class="portal-card" data-addr-picker="?id=<?= (int)$id ?>">
    ...
    <div class="form form-grid">
      ...
      <div class="field"><label>Latitude</label>
        <input type="number" step="any" name="lat" id="addr-lat" value="<?= $v('lat') ?>" placeholder="-26.7100000" data-addr-lat>
      </div>
      <div class="field"><label>Longitude</label>
        <input type="number" step="any" name="lng" id="addr-lng" value="<?= $v('lng') ?>" placeholder="27.8300000" data-addr-lng>
      </div>
    </div>
    <div id="addr-map" class="addr-map" aria-label="Click or drag the pin to set GPS coordinates" data-addr-map></div>
    <p class="muted small" id="addr-hint" style="margin:8px 0 0;" data-addr-hint>
    ...
    <div class="form-actions" style="margin-top:8px; flex-wrap:wrap;">
      <button type="button" id="addr-locate"  class="btn btn-ghost btn-sm" data-addr-locate>Use my location</button>
      <button type="button" id="addr-reverse" class="btn btn-ghost btn-sm" data-addr-reverse>Fill address from pin</button>
